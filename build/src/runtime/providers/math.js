...
var deprecated_1 = require("../util/deprecated");
...
var Sin = (function (_super) {
    ...
    Sin.prototype.getAngle = function (angle) {
        return [Math.sin(angle * (Math.PI / 180))];
    };
    Sin.prototype.getSin = function (degrees, radians) {
    ...
    __decorate([
        deprecated_1.deprecated('Please use degrees instead of angle')
    ], Sin.prototype, "getAngle", null);
    return Sin;
}(join_1.Constraint));
...
var Cos = (function (_super) {
    ...
    Cos.prototype.getAngle = function (angle) {
        return [Math.cos(angle * (Math.PI / 180))];
    };
    Cos.prototype.getCos = function (degrees, radians) {
        if (degrees !== undefined) {

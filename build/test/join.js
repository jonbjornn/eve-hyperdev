...
test("Should be able to use the sin function with degrees and radians", function (assert) {
    var expected = {
        insert: [
            ["a", "tag", "div"],
            ["a", "text", "1"],
...
test("Should be able to use the cos function with degrees and radians", function (assert) {
    var expected = {
        insert: [
            ["a", "tag", "div"],
            ["a", "text", "1"],
...
test("Should still be able to use the trig function with angle - deprecated", function (assert) {
    var expected = {
        insert: [
            ["a", "tag", "div"],
            ["a", "text", "1"],
...
test("nested if/not expressions correctly get their args set", function (assert) {
    var expected = {
        insert: [
            ["c", "tag", "item"],
            ["c", "idx", 0],
